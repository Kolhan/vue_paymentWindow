...
<template>
    <div class="page withFooter bg-green-400 h-screen grid"> 
        
        <div class="mt-12 text-center text-3xl text-white">
            <div class="inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="100px" height="100px" viewBox="0 0 1280.000000 1253.000000" preserveAspectRatio="xMidYMid meet">
